...
public class ExampleMutationListener implements MutationListener {
    ...
    public void vertexAdded(Vertex vertex) {
        LOGGER.info("AMINE vertexAdded!!!!! " + StringFactory.vertexString(vertex));
        System.out.println("AMINE vertexAdded!!!!! " + StringFactory.vertexString(vertex));
    }
    ...
    public void vertexPropertyChanged(Vertex element, Property oldValue, Object setValue, Object... vertexPropertyKeyValues) {
        ...
        System.out.println("AMINE vertexPropertyChanged!!!!! " + StringFactory.vertexString(element) + " " + StringFactory.propertyString(oldValue) + " " + setValue);
    }
