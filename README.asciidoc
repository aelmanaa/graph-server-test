...
link:http://tinkerpop.apache.org/docs/3.2.4/reference/#gremlin-server[Gremlin Server] project is structured
with Maven. This project demonstrates how to connect to Gremlin Server through Java using the
link:http://tinkerpop.apache.org/docs/3.2.4/reference/#connecting-via-java[Gremlin Driver] that is
...
[source,text]
mvn exec:java -Dexec.mainClass="com.my.App" -Dlog4j.configuration=file:conf/log4j.properties